...
public class Ronda {
    ...
    public String seleccionPalabra() {
        switch (temaPartida) {
            ...
            case "Colores" -> {
                palabraActual = colores[generarPosicionAleatoria()];
                System.out.printf("El color es: %s\n",palabraActual);
            }
            case "Animales" -> {
                palabraActual = animales[generarPosicionAleatoria()];
                System.out.printf("El animal es: %s\n",palabraActual);
            }
            case "Frutas" -> {
                palabraActual = frutas[generarPosicionAleatoria()];
